...
insert into users (`user_name`,`password`,`sms_number`,`avatar_id`,`active`,`send_email`,`send_sms`,`user_type`,`deleted`,`create_date`,`last_change_date`) values ('admin@admin.io', 'oMK+aYh5Hp/KdIWISbljvA2Oz68VUwsCKl/X5HUhSto=$L+kxRounHxTKKn4woxh/vQ8xNBtwHq5tgYqfYdhfsYg=', '+8015551234', 0, 1, 1, 0, 1, 0, now(), now());

insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Sunday', 0, 23, 0, 2, 6, 0, 1, 1, 0, now(), now());
insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Monday', 1, 23, 0, 3, 6, 0, 1, 1, 0, now(), now());
insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Tuesday', 2, 23, 0, 4, 6, 0, 1, 1, 0, now(), now());
insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Wednesday', 3, 23, 0, 5, 6, 0, 1, 1, 0, now(), now());
insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Thursday', 4, 23, 0, 6, 6, 0, 1, 1, 0, now(), now());
insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Friday', 5, 23, 0, 7, 6, 0, 1, 1, 0, now(), now());
insert into security_schedules (`app_module_id`,`schedule_name`,`start_day`,`start_hour`,`start_minute`,`end_day`,`end_hour`,`end_minute`,`alert_rule_id`,`active`, `deleted`,`create_date`,`last_change_date`) value (1, 'Daily Schedule - Saturday', 6, 23, 0, 1, 6, 0, 1, 1, 0, now(), now());
