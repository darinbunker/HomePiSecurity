...
insert into system_state (`app_module`,`active`,`active_override`,`override_alert_rule`,`general_alert_rule`,`active_schedule`,`deactivate_override`,`last_change_date`) values ('door_security', 1, 0, 1, 1, 0, 0, now());
